...
function countryDataToJSON(countryData) {
  var countryDataColumns = CSVToArray(countryData)[0];
...
async.series([deleteFile, processFile]);

// THE CODE BELOW IS THIRD PARTY CSV PARSING CODE
// credit: http://stackoverflow.com/questions/1293147/javascript-code-to-parse-csv-data
